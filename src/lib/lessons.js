...
export const LESSONS = [
  {
    ...
    body: 'Սուր՝ 90°-ից փոքր։ Ուղղիղ՝ ճիշտ 90°։ Բութ՝ 90°-ի և 180°-ի միջև։ Փռված՝ 180°, ուղղիղ գիծ։ Ավելին՝ գոգավոր։',
  },
  {
    id: 'complement',
    group: 'angles',
  ...
  },
  {
    ...
    formula: 'a² + b² = c²',
    body: 'Ուղղանկյուն եռանկյան կաթետների քառակուսիների գումարը հավասար է ներքնաձիգի քառակուսուն։ 3 և 4 վանդակ՝ ներքնաձիգը ճիշտ 5 վանդակ։',
  },
  {
    id: 'area',
    group: 'measure',
